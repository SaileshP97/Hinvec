...
BATCH_SIZE=16  # Small batch size for full model fine-tuning
MAX_LENGTH=64 #512
LEARNING_RATE=2e-6  # Lower learning rate for full model fine-tuning
NUM_EPOCHS=1
DATA_DIR="./new_training_data"
OUTPUT_DIR="./checkpoints/ganga-2-1b-embeddings-new-equall-bidir"
ZERO_STAGE=3
...
python trainer_with_deepspeed_bidir.py \
